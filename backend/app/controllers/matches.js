        ...
        if(validity == "valid") {
            if(lastBall.ballNo == 6) {
                ...
                if(scoreCardTeam == "scoreCardTeam1") {
                    ...
                    if(balls.length != 0) {
                        await service.findOneAndUpdate(overCollection, {matchId: req.body.matchId, over: nextOverNo-1}, {matchId: req.body.matchId, team2Runs: runs, team2Wickets: wickets, bowlerId2: id, team1Name: req.match.team1Name, team2Name: req.match.team2Name, bowler2Name: bowlerName});
                    }
                }
